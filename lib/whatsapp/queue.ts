...
export const whatsappQueue = new Queue<MensajeJobData>("whatsapp-messages", {
...
export const whatsappWorker = new Worker<MensajeJobData>("whatsapp-messages", procesarMensaje, {
  connection: redisConnection,
  concurrency: 1,
  limiter: {
    max: 20,
